...
function complete(){
    ...
    if(id==0){
        if (document.getElementById("im1").src.endsWith("green.png")){
            document.getElementById("im1").src = "image1.png";
            /*var image = new Image();
        ...
        if (document.getElementById("im2").src.endsWith("green.png")){
            document.getElementById("im2").src = "image2.png";
        }
    }
    else if(id==2){
        if (document.getElementById("im3").src.endsWith("green.png")){
            document.getElementById("im3").src = "image3.png";
        }
    }
    else if(id==3){
        if (document.getElementById("im4").src.endsWith("green.png")){
            document.getElementById("im4").src = "image4.png";
        }
    }
    else if(id==4){
        if (document.getElementById("im5").src.endsWith("green.png")){
            document.getElementById("im5").src = "image5.png";
        }
    }
    else if(id==5){
